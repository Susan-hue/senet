...
urlpatterns = [
    ...
    path("results/export-jobs/<uuid:pk>", ExportJobDetailView.as_view(), name="export-job-detail"),
    ...
    path("results/<uuid:pk>/ogr", OGRExportView.as_view(), name="result-ogr"),
    path("results/<uuid:pk>/broadsheet", BroadsheetExportView.as_view(), name="result-broadsheet"),
